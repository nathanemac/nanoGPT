# Config for Rank-Adaptive LOZO pretraining on OpenWebText dataset
# Demonstrates rank scheduling from min_rank=1 to max_rank=16 across training

# Output directory
out_dir = 'out-rank-adaptive-lozo-owt'
...
step_interval = 50  # interval for updating the V matrices (unified with other methods)
