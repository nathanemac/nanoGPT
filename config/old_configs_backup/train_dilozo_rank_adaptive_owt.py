# Config for DiLoZO with Rank Adaptive training on OpenWebText dataset

# Output directory
out_dir = 'out-dilozo-rank-adaptive-owt'
...
wandb_run_name = 'dilozo-rank-adaptive-owt'
...
rank_r = 16        # Base rank (used when rank_adaptive=False)
step_interval = 50 # Interval for updating V matrices (unified with other methods)

# DiLoZO Momentum settings
use_momentum = False
momentum_beta = 0.9

# Rank-adaptive DiLoZO parameters
